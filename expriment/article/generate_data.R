...
# # ---------------------------
# # Generate X -- iid N(0, 1/n) entries, seeds 1, 2, and 3
# # ---------------------------
...
# ---------------------------
# Generate X -- iid multivariate Gaussian rows, with correlated coordinates. seeds 4, 5, and 6
# ---------------------------
...
# ---------------------------
# Generate betas: Basic Gaussian N(0, 1) truncated at [-3, 3]. Seed 1 and 4
# ---------------------------
...
# # ---------------------------
# # Generate betas: truncated continuous spike-and-slab Seed 2 and 5
# # ---------------------------
# pi_slab <- 0.5
# tau0 <- 0.04
# tau1 <- 1.0
...
# # ---------------------------
# # Generate betas: bimodal Seed 3 and 6
# # ---------------------------
# pi_left_mode <- 0.5
# tau0 <- 0.2
# tau1 <- 0.2
